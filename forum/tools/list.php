            ...
            if ($qryData->numRows()) {
                ...
                while ($qryRow = $qryData->fetchRow(DB_FETCHMODE_ASSOC)) {
                    ...
                    <tr valign="top" bgcolor="<?php print $bgcolor; ?>">
                        <td><b>&raquo;</b> <a href="/forum/view_bb.php?forum=<?php print $qryRow["intForum"]; ?>&thread=<?php print $qryRow["ID"]; ?>"><b><?php print $qryRow["strTitle"]; ?></b></a></td>
                        <td><a href="/forum/topics_bb.php?forum=<?php print $qryRow["intForum"]; ?>"><b><?php print $qryRow["strName"]; ?></b></a></td>
