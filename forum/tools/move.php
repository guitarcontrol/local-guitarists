<?php
    ...
    */
    ...
    if (!$process) {
        ...
        $moveText = "This thread has been moved to <b>" . $qryNew["strName"] . "</b>. You can view and reply to it <a href=\"/forum/view_bb.php?forum=" . $qryNew["ID"] . "&thread=" . $_POST["ID"] . "\"><b>here</b></a>.";
        ...
        opener.location.replace(\"/forum/topics_bb.php?forum=" . $_POST["forumID"] . "&thread=" . $_POST["ID"] . "\");
        self.close();
        </script>";
        exit();
    }
