...
?>
    ...
    <br>
    <div align="center">
    <form name="myForm" action="submit_bb_new.php" method="post" onSubmit="return checkPost()">
    ...
    <tr valign="top" align="center">
        ...
        <tr>
            ...
            <input type="button" value="Cancel" onclick="location.href='/forum/view_bb.php?forum=<?php print $qryTopic["intForum"]; ?>&thread=<?php print $qryTopic["ID"]; ?>';" class="smbutton">
            </td>
        </tr>
        <tr>
            <td colspan="3"><br />
            <b>Previous Discussions:</b><br />
            <iframe src="/forum/reply/list.php?forum=<?php print $qryTopic["intForum"]; ?>&thread=<?php print $qryTopic["ID"]; ?>" frameborder="0" scrolling="auto" name="list" width="100%" height="300" marginwidth="0" marginheight="0">
