<?php
    ...
    */
    ...
    $msgText = "<a href=\"/forum/tools/listthreads.php?memID=" . $_SESSION["MemberID"] . "\"><b>" . $_SESSION["Username"] . "</b></a> has reported the following thread posted by <a href=\"/forum/tools/listthreads.php?memID=" . $qryData["intMemID"] . "\"><b>" . $qryData["strUsername"] . "</b></a>";
    $msgText .= " on " . date("n/j/Y \@ g:i a") . ":<p>";
    $msgText .= "<i>" . trim($qryData["postText"]) . "</i><p>";
    $msgText .= "The thread can be seen <a href=\"/forum/view_bb.php?forum=" . $_GET["forum"] . "&thread=" . $_GET["thread"] . "\"><b>here</b></a>.";
    ...
    location.replace(\"/forum/view_bb.php?forum=" . $_GET["forum"] . "&thread=" . $_GET["thread"] . "\");
    </script>";
?>