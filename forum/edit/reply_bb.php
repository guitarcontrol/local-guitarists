...
?>
    ...
    <tr valign="top" align="center">
        ...
        <tr>
            ...
            <input type="button" value="Cancel" onclick="location.href='/forum/view_bb.php?forum=<?php print $qryTopic["intForum"]; ?>&thread=<?php print $qryTopic["ID"]; ?>#post<?php print $arrReply["ID"]; ?>';" class="smbutton">
            </td>
        </tr>
        </table>
        </form>
