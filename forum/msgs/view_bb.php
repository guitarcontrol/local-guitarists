...
?>
    ...
    <tr valign="top">
        ...
        <tr>
            <td class="tablehead">&nbsp;&raquo;&nbsp;<a href="/index.php"><b>Home</b></a>&nbsp;&raquo;&nbsp;<a href="/forum/index.php"><b>Guitar Discussion</b></a>&nbsp;&raquo;&nbsp;<a href="/forum/msgs/index.php"><b>Private Messages</b></a>&nbsp;&raquo;&nbsp;<?php print $qryMessage["strTitle"]; ?></td>
        </tr>
        </table>
        ...
        <tr>
            ...
            <select name="option" class="dropdown" onChange="location.href=this.value">
                <option value="/forum/msgs/reply/index_bb.php?msg=<?php print $qryMessage["msgID"]; ?>">&nbsp;&raquo;&nbsp;Post A Reply</option>
                <option value="/forum/msgs/post/index_bb.php">&nbsp;&raquo;&nbsp;Post New Message</option>
                <option value="/forum/msgs/delete.php?id=<?php print $_GET["id"]; ?>">&nbsp;&raquo;&nbsp;Delete Message &amp; Replies</option>
                <option value="/forum/msgs/index.php">&nbsp;&raquo;&nbsp;View Message List</option>
            </select>
                ...
                if ($qryMessage["intAllowChat"] && $_SESSION["MemberID"]) {
                    ...
                    if ($qryMessage["intAllowChat"] == 1 || ($qryMessage["intAllowChat"] == 2 && $_SESSION["MemberID"]) || ($qryMessage["intAllowChat"] == 3 && $_SESSION["AccessLevel"] >= 90)) {
                        ...
                        if (strlen($qryMessage["strAIM"])) {
                            print "<a href=\"aim:goim?screenname=" . trim($qryMessage["strAIM"]) . "&message=G-Net+member+chat\"><img src=\"/forum/images/aim.gif\" width=\"26\" height=\"20\" alt=\"Send AIM\" border=\"0\"></a>";
                        }
                        
                        // check ICQ
                        if (strlen($qryMessage["strICQ"])) {
                            print "<a href=\"http://wwp.icq.com/scripts/search.dll?to=" . trim($qryMessage["strICQ"]) . "\" target=\"_new\"><img src=\"/forum/images/icq.gif\" width=\"18\" height=\"20\" alt=\"Send ICQ\" border=\"0\"></a>";
                        }
                        
                        // check MSN Messenger
                        if (strlen($qryMessage["strMSN"])) {
                            print "<img src=\"/forum/images/msn.gif\" width=\"21\" height=\"20\" alt=\"" . trim($qryMessage["strMSN"]) . "\" border=\"0\">";
                        }
                        
                        // check Yahoo! Messenger
                        if (strlen($qryMessage["strYahoo"])) {
                            print "<a href=\"http://edit.yahoo.com/config/send_webmesg?.target=" . trim($qryMessage["strYahoo"]) . "&.src=pg\" target=\"_new\"><img src=\"/forum/images/yahoo.gif\" width=\"24\" height=\"20\" alt=\"Send Yahoo! Message\" border=\"0\"></a>";
                        }
                    }
                    print "<br>";
                }
