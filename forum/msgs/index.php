...
?>
    ...
    <tr valign="top">
        ...
        <tr>
            <td class="tablehead">&nbsp;&raquo;&nbsp;<a href="/index.php"><b>Home</b></a>&nbsp;&raquo;&nbsp;<a href="/forum/index.php"><b>Guitar Discussion</b></a>&nbsp;&raquo;&nbsp;Your Private Messages</td>
        </tr>
        </table>
        ...
        <?php
            ...
            if ($qryTopics->numRows()) {
                ...
                if ($qryTopics->numRows() > $intDisplay) {
                    ...
                    $strURL = "/forum/msgs/index.php?id=" . $_SESSION["MemberID"] . "&";
