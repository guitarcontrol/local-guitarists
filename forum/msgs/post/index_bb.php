...
?>
    ...
    <tr valign="top">
        ...
        <tr>
            <td class="tablehead">&nbsp;&raquo;&nbsp;<a href="/index.php"><b>Home</b></a>&nbsp;&raquo;&nbsp;<a href="/forum/index.php"><b>Guitar Discussion</b></a>&nbsp;&raquo;&nbsp;<a href="/forum/msgs/index.php"><b>Private Messages</b></a>&nbsp;&raquo;&nbsp;Send a New Message<?php if (strlen($qryUser["strUsername"])) { print " to " . $qryUser["strUsername"]; } ?></td>
        </tr>
        </table>
