    ...
    */
    ...
    ?>
        ...
        <tr valign="top" align="center">
            ...
            <tr>
                <td class="tablehead">&nbsp;&raquo;&nbsp;<a href="/index.php"><b>Home</b></a>&nbsp;&raquo;&nbsp;<a href="/forum/index.php"><b>Guitar Discussions</b></a>&nbsp;&raquo;&nbsp;<a href="/forum/topics_bb.php?forum=<?php print $_POST["intForum"]; ?>"><b><?php print $qryForum["strName"]; ?></b></a>&nbsp;&raquo;&nbsp;Start a new thread</td>
            </tr>
            </table>
        ...
        ?>
            ...
            <tr>
                ...
                <input type="button" value="Cancel" onclick="location.href='/forum/topics_bb.php?forum=<?php print $_POST["intForum"]; ?>';" class="smbutton">
                </td>
            </tr>
            <?php
        ...
        print "
        <script language=\"JavaScript\">
        location.replace(\"/forum/topics_bb.php?forum=" . $_POST["intForum"] . "\");
        </script>";
    }
?>
