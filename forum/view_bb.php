...
?>
    ...
    <tr>
        <td class="tablehead">&nbsp;&raquo;&nbsp;<a href="/index.php"><b>Home</b></a>&nbsp;&raquo;&nbsp;<a href="/forum/index.php"><b>Guitar Discussions</b></a>&nbsp;&raquo;&nbsp;<a href="/forum/topics_bb.php?forum=<?php print $_GET["forum"]; ?>"><b><?php print $qryMain["strName"]; ?></b></a>&nbsp;&raquo;&nbsp;<?php print $qryMain["strTitle"]; ?></td>
    </tr>
    </table>
    ...
    <tr valign="top">
            ...
            <tr>
                ...
                <?php
                    ...
                    if ($qryMain["bitReply"] && $_SESSION["MemberID"]) {
                        print "<option value=\"/forum/reply/index_bb.php?thread=" . $_GET["thread"] . "\">&nbsp;&raquo;&nbsp;Post A Reply</option>";
                    }
                    
                    // see if they're logged in
                    if ($_SESSION["MemberID"]) {
                        // allow them to start a new thread
                        print "<option value=\"/forum/post/index_bb.php?forum=" . $_GET["forum"] . "\">&nbsp;&raquo;&nbsp;Start a New Thread</option>";
                        ...
                        if (count($arrSaved)) {
                            ...
                            if (!in_array($_GET["thread"], $arrSaved)) {
                                ?>
                                <option value="javascript:plainWin('/forum/subscribe.php?forum=<?php print $_GET["forum"]; ?>&thread=<?php print $_GET["thread"]; ?>&status=1','250','100')">&nbsp;&raquo;&nbsp;Subscribe To Thread</option>
                                <?php
                            } else {
                                ?>
                                <option value="javascript:plainWin('/forum/subscribe.php?forum=<?php print $_GET["forum"]; ?>&thread=<?php print $_GET["thread"]; ?>&status=0','250','100')">&nbsp;&raquo;&nbsp;Unsubscribe To Thread</option>
                                <?php
                            }
                        } else {
                            ?>
                        ...
                        ?>
                        <option value="/forum/deliver.php?thread=<?php print $_GET["thread"]; ?>">&nbsp;&raquo;&nbsp;Email To A Friend</option>
                        <option value="/forum/myposts.php">&nbsp;&raquo;&nbsp;View Your Posts</option>
                        <?php
                    }
                    ?>
                    <option value="/forum/recent.php">&nbsp;&raquo;&nbsp;Most Recent Posts</option>
                    <option value="/forum/topics_bb.php?forum=<?php print $qryMain["forumID"]; ?>">&nbsp;&raquo;&nbsp;More Threads</option>
        ...
        <?php
            ...
            if ($qryMain["bitReply"] && $_SESSION["MemberID"]) {
                ?>
                <form name="myForm" action="/forum/reply/submit_bb.php" method="post">
