        ...
        <?php
            ...
            if ($qrySearch->numRows()) {
                ...
                while ($qryRow = $qrySearch->fetchRow(DB_FETCHMODE_ASSOC)) {
                    ...
                    if ($row >= $startRow && $row <= $endRow) {
                        ...
                        <tr valign="middle" bgcolor="<?php print $bgcolor; ?>">
                            <td><b><a href="view_bb.php?forum=<?php print $qryRow["intForum"]; ?>&thread=<?php print $qryRow["ID"]; ?>&mark=<?php print $_GET["terms"]; ?>"><?php print $qryRow["strTitle"]; ?></a></b></td>
                            ...
                            <td class="smalltxt" align="center"><a href="/members/profile.php?user=<?php print $qryRow["intMemID"]; ?>"><b><?php print $qryRow["strUsername"]; ?></b></a></td>
                ...
                if ($qrySearch->numRows() > $intDisplayNum) {
                    ...
                    $strURL = "results.php?terms=" . $_GET["terms"] . "&username=" . $_GET["username"] . "&searchOption=" . $_GET["searchOption"] . "&searchIn=" . $_GET["searchIn"] . "&days=" . $_GET["days"] . "&forumID=" . $_GET["forumID"] . "&sort=" . $_GET["sort"] . "&order=" . $_GET["order"] . "&";
                ...
                <tr>
                    ...
                    <a href="search.php"><b>try again</b></a>.
                    </td>
                </tr>
                <?php
            }
