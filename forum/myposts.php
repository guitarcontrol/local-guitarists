...
?>
    ...
    <tr valign="top">
        ...
        <tr>
            <td class="tablehead">&nbsp;&raquo;&nbsp;<a href="/index.php"><b>Home</b></a>&nbsp;&raquo;&nbsp;<a href="/forum/index.php"><b>Guitar Discussions</b></a>&nbsp;&raquo;&nbsp;My Topics</td>
        </tr>
        </table>
            ...
            if ($qryTopics->numRows()) {
                ...
                while ($qryRow = $qryTopics->fetchRow(DB_FETCHMODE_ASSOC)) {
                    ...
                    <tr valign="middle" bgcolor="<?php print $bgcolor; ?>">
                        ...
                        <td valign="top">
                        <b><a href="/forum/view_bb.php?forum=<?php print $qryRow["intForum"]; ?>&thread=<?php print $qryRow["ID"]; ?>">
                        <?php
