    ...
    */
    ...
    if ($startRow == 0) {
        ...
        <tr valign="top">
            ...
            if ($_SESSION["MemberID"] == $qryMain["intMemID"] || $_SESSION["AccessLevel"] >= 90) {
                ?>
                <br>
                &raquo; <a href="/forum_ggc/edit/post.php?id=<?php print $qryMain["topicID"]; ?>"><b>Edit Topic</b></a><br>
    ...
    if ($qryReplies->numRows()) {
        ...
        if ($qryReplies->numRows() > $intDisplayNum) {
            ...
            $strURL = "/forum_ggc/view.php?forum=". $_GET["forum"] . "&thread=" . $_GET["thread"] . "&display=$intDisplayNum&sort=$sortOrder&";
