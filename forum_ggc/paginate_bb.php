    ...
    if ($startRow == 0) {
        ...
        <tr valign="top">
            ...
            if ($_SESSION["MemberID"] == $qryMain["intMemID"] || $_SESSION["AccessLevel"] >= 90) {
                ?>
                <br>
                &raquo; <a href="/forum_ggc/edit/post_bb.php?id=<?php print $qryMain["topicID"]; ?>"><b>Edit Topic</b></a><br>
        ...
        if ($_SESSION["MemberID"] && $qryMain["ID"] != $_SESSION["MemberID"]) {
            ...
            if (!$qryMain["intBanned"]) {
                ...
                &raquo; <a href="/members_ggc/buddy.php?id=<?php print $qryMain["intMemID"]; ?>&return=/forum_ggc/view_bb.php?<?php print $_SERVER["QUERY_STRING"]; ?>"><b>Add to "Buddy List"</b></a><br>
                <?php
            }
            }
                ...
                <tr>
                    ...
                    if ($_SESSION["MemberID"] && $qryRow["intMemID"] != $_SESSION["MemberID"]) {
                        ...
                        if (!$qryRow["intBanned"]) {
                            ...
                            &raquo; <a href=\"/members_ggc/buddy.php?id=" . $qryRow["intMemID"] . "&return=/forum_ggc/view_bb.php?" . $_SERVER["QUERY_STRING"] . "\"><b>Add to \"Buddy List\"</b></a><br>\n";
                        }
                    }
