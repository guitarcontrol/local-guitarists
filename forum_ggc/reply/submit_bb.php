...
?>
        ...
        <tr valign="top" align="center">
            ...
            <tr>
                ...
                <input type="button" value="Cancel" onclick="location.href='/forum_ggc/view_bb.php?forum=<?php print $_POST["intForum"]; ?>&thread=<?php print $_POST["intTopic"]; ?>';" class="smbutton">
                </td>
            </tr>
            <?php
        ...
        $location = "/forum_ggc/view_bb.php?forum=" . $qryCount["ID"] . "&thread=" . $_POST["intTopic"] . "#post" . $qryLast_ID;
        
        // redirect them
        print "
        <script language=\"JavaScript\">
        location.replace(\"/forum_ggc/view_bb.php?forum=" . $qryCount["ID"] . "&thread=" . $_POST["intTopic"] . "#post" . $qryLast_ID . "\");
        </script>";
    }
?>
