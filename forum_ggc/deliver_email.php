<?php
    ...
    */
    ...
    $emailText .= "http://www.guitarists.net/forum_ggc/view_bb.php?forum=" . $qryThread["intForum"] . "&thread=" . $qryThread["ID"] . "\n";
    $emailText .= "- or -\n";
    $emailText .= "<a href=\"http://www.guitarists.net/forum_ggc/view_bb.php?forum=" . $qryThread["intForum"] . "&thread=" . $qryThread["ID"] . "\">Click Here</a>\n\n";
    ...
    location.replace(\"/forum_ggc/view_bb.php?forum=" . $qryThread["intForum"] . "&thread=" . $qryThread["ID"] . "\");
    </script>";
    exit();
