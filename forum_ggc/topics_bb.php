    ...
    <tr valign="top">
            ...
            <tr>
                ...
                <?php
                    ...
                    if (!$qryForum["intPrivate"] && $_SESSION["MemberID"]) {
                        ...
                        print "<option value=\"/forum_ggc/post/index.php?forum=" . $qryForum["ID"] . "\">&nbsp;&raquo;&nbsp;Start A Thread</option>";
        ...
        <?php
            ...
            if ($qryTopics->numRows() > $intDisplayNum) {
                ...
                $strURL = "/forum_ggc/topics_bb.php?forum=" . $qryForum["ID"] . "&days=$myDays&display=$intDisplayNum&";
            ...
            if ($qryTopics->numRows()) {
                        ...
                        <tr valign="middle" bgcolor="<?php print $bgcolor; ?>">
                            ...
                            if ($_SESSION["MemberID"]) {
                                ...
                                if (strtotime($qryRow["dateLastPost"]) > strtotime($_SESSION["LastLogin"])) {
                                    ?>
                                    <img src="/forum_ggc/images/new.gif" width="11" height="12" alt="New!">
                                    <?php
                                }
                            }
                            ...
                            if ($qryRow["intSticky"]) {
                                ?>
                                <img src="/forum_ggc/images/sticky.gif" align="absmiddle" width="11" height="12" alt="Sticky">
                                <?php
                            }
                            ...
                            if (!$qryRow["bitReply"]) {
                                ...
                                <img src="/forum_ggc/images/locked.gif" align="absmiddle" width="11" height="12" alt="Sticky">
                            ...
                            ?></td>
                                ...
                                <b><a href="/forum_ggc/view_bb.php?forum=<?php print $qryForum["ID"]; ?>&thread=<?php print $qryRow["ID"]; ?>">
                ...
                <tr>
                    ...
                    <img src="/forum_ggc/images/locked.gif" width="11" height="12" alt="Read Only" border="0"> 

                    indicates a "read only" post&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                    <img src="/forum_ggc/images/sticky.gif" width="12" height="12" alt="Sticky" border="0"> 
            ...
            <tr>
                ...
                <a href="/forum_ggc/post/index.php?forum=<?php print $qryForum["ID"]; ?>" title="Start a New Thread"><img src="/images/submit_thread.png" width="160" height="38" alt="Start a New Thread" border="0" /></a>
