...
?>
        ...
        <tr valign="top">
            ...
            <tr>
                <td class="tablehead">&nbsp;&raquo;&nbsp;<a href="/index.php"><b>Home</b></a>&nbsp;&raquo;&nbsp;<a href="/forum_ggc/index.php"><b>Guitar Discussion</b></a>&nbsp;&raquo;&nbsp;<a href="/forum_ggc/msgs/index.php"><b>Private Messages</b></a>&nbsp;&raquo;&nbsp;Edit Post '<?php print trim(str_replace('"', "&quot;", $_POST["strTitle"])); ?>'</td>
            </tr>
            </table>
            <?php } ?>
    ...
    // update our redirect
    $strURL = "/forum_ggc/msgs/view_bb.php?id=" . $_POST["ID"];
