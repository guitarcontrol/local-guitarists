...
?>
    ...
    <tr valign="top" align="center">
        ...
        <tr>
            <td class="tablehead">&nbsp;&raquo;&nbsp;<a href="/index.php"><b>Home</b></a>&nbsp;&raquo;&nbsp;<a href="/forum_ggc/index.php"><b>Guitar Discussions</b></a>&nbsp;&raquo;&nbsp;<a href="/forum_ggc/topics_bb.php?forum=<?php print $arrPost["intForum"]; ?>"><b><?php print $arrForum["strName"]; ?></b></a>&nbsp;&raquo;&nbsp;Edit '<?php print $arrPost["strTitle"]; ?>'</td>
        </tr>
        </table>
        <?php } ?>
        ...
        <tr>
            ...
            <input type="button" value="Cancel" onclick="location.href='/forum_ggc/view_bb.php?forum=<?php print $arrForum["ID"]; ?>&thread=<?php print $arrPost["ID"]; ?>';" class="smbutton">
            </td>
        </tr>
        <!--<tr>
            <td><br></td>
