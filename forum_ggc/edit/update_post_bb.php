...
?>
        ...
        <tr valign="top" align="center">
            ...
            <tr>
                <td class="tablehead">&nbsp;&raquo;&nbsp;<a href="/index.php"><b>Home</b></a>&nbsp;&raquo;&nbsp;<a href="/forum_ggc/index.php"><b>Guitar Discussions</b></a>&nbsp;&raquo;&nbsp;<a href="/forum_ggc/topics_bb.php?forum=<?php print $arrForum["ID"]; ?>"><b><?php print $arrForum["strName"]; ?></b></a>&nbsp;&raquo;&nbsp;Preview '<?php print trim(stripslashes($_POST["strTitle"])); ?>'</td>
            </tr>
            </table>
            <?php } ?>
            ...
            <tr>
                ...
                <input type="button" value="Cancel" onclick="location.href='/forum_ggc/view_bb.php?forum=<?php print $arrForum["ID"]; ?>&thread=<?php print $_POST["ID"]; ?>';" class="smbutton">
                </td>
            </tr>
            <?php
        ...
        location.replace(\"/forum_ggc/view_bb.php?forum=" . $_POST["intForum"] . "&thread=" . $_POST["ID"] . "\");
        </script>";
    }
?>
