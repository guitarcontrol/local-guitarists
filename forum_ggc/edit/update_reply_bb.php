...
?>
        ...
        <tr valign="top" align="center">
            ...
            <tr>
                ...
                <input type="button" value="Cancel" onclick="location.href='/forum_ggc/view_bb.php?forum=<?php print $qryTopic["intForum"]; ?>&thread=<?php print $qryTopic["ID"]; ?>#post<?php print $_POST["ID"]; ?>';" class="smbutton">
                </td>
            </tr>
            <?php
        ...
        location.replace(\"/forum_ggc/view_bb.php?forum=" . $_POST["intForum"] . "&thread=" . $_POST["intTopic"] . "#post" . $_POST["ID"] . "\");
        </script>";
    }
?>
