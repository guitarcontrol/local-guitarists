...
<?php if (empty($_SESSION["GGCIFrame"])) { ?>
    ...
    <tr valign="top">
        ...
        <tr>
            <td class="tablehead">&nbsp;&raquo;&nbsp;<a href="/index.php"><b>Home</b></a>&nbsp;&raquo;&nbsp;<a href="/forum_ggc/index.php"><b>Guitar Discussions</b></a>&nbsp;&raquo;&nbsp;The Last 50 Topics</td>
        </tr>
        </table>
<?php } ?>
            ...
            if ($qryTopics->numRows()) {
                ...
                while ($qryRow = $qryTopics->fetchRow(DB_FETCHMODE_ASSOC)) {
                    ...
                    <tr valign="middle" bgcolor="<?php print $bgcolor; ?>">
                        <td>
                        <b><a href="/forum_ggc/view_bb.php?forum=<?php print $qryRow["intForum"]; ?>&thread=<?php print $qryRow["ID"]; ?>"><?php print $qryRow["strTitle"]; ?></a></b><br />
