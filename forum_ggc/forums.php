        ...
        <?php
            ...
            while ($qryRow = $qryForums->fetchRow(DB_FETCHMODE_ASSOC)) {
                ...
                <tr>
                    ...
                    <td bgcolor="#f6f6f6"><img src="/images/pointer.gif" width="11" height="11" alt="" border="0">&nbsp;<a href="/forum_ggc/topics_bb.php?forum=<?php print $qryRow["ID"]; ?>"><b><?php print $qryRow["strName"]; ?></b></a><br>
